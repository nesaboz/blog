...
<center>
    <figure>
    <img width="500" src="midjourney_solar_panels_in_the_desert.png"/>
    </figure>
</center>


# Solar panel segmentation
> Detecting solar panels from satellite images ([github](https://github.com/nesaboz/solar))
...
Images of solar farms were obtained using Airbus Defence and Space satelites. Data preparation and cleaning was intensive. Most labels were provided though quality was not ideal (nonetheless I am grateful for what seems to have been a painful labeling job). I generated dozens of additional labels 
using [LabelMe](https://github.com/wkentaro/labelme). 
The large (~1GB) satellite images were split into smaller ones (256x256 pixels size). 
