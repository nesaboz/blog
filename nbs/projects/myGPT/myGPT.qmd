...
date: 2024-02-08
toc: true
title: Chatbot based on OpenAI's GPT-4
image:  myGPT_thumbnail.jpg
tags: [technical]
---

A simple chatbot was developed based on OpenAI's GPT4 model (specifically `gpt-4-1106-preview`). APIs were called by AWS Lambda, supporting both `requests` and `boto3` library calls. Web app was written in Streamlit and hosted on [custom EC2 instance](https://www.nenadbozinovic.com/tips/015_Cloud/aws/host_web_app.html). CI/CD was done using [GitHub Actions](https://www.nenadbozinovic.com/tips/015_Cloud/github_actions.html). 
