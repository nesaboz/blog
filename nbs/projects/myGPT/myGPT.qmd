...
A simple chatbot was developed based on OpenAI's GPT3 model. APIs were called by AWS Lambda, supporting both `requests` and `boto3` library calls. Web app was written in Streamlit and hosted on custom EC2 instance. CI/CD was done using GitHub Actions. 
